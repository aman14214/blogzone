...
function Header() {
  ...
  return (
    ...
    // duration-500 lg:z-50 lg:border-b lg:border-slate-100/10  supports-backdrop-blur:bg-white/60 bg-transparent
    // ">
    <div className="
    sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 
    lg:border-b lg:border-slate-100/10 bg-gradient-to-r from-[#14532d] to-[#155e75]
  ">
  {/* <div className="
    sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 
    lg:border-b lg:border-slate-100/10 bg-[#115e59]
  "> */}
      ...
      <div className=" basis-[0]  mx-auto flex max-w-7xl items-center justify-between lg:justify-normal w-full px-4 py-3 sm:px-6 lg:px-8">
        <Link to="/" className="flex items-center">
          <div className="inline-flex items-center  space-x-2">
            ...
            <span className="font-bold hover:text-sky-500 ">BlogZone</span>
          </div>
        </Link>
        {/* 54 */}
